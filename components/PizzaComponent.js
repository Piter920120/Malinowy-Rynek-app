      ...
      {data.map((item, index) => (
        <Pressable style={{ borderEndColor: "#AFD8F5", borderWidth: 0.1 }}>
          <Image
            ...
            source={item.image}
          />
          <View style={{ backgroundColor: "#e46178", padding: 10 }}>
            ...
            >
              <View>
                <Text style={{ color: "white", fontSize: 15 }}>Cena</Text>
